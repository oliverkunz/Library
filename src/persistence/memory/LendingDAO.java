...
public class LendingDAO implements ILendingDAO {
	...
	private void loadLendings() throws NoItemsFoundException, ItemNotAvailableException {
	...
	@Override
	public Lending[] getLendings() throws NoItemsFoundException, ItemNotAvailableException {
		if (lendings == null)
			loadLendings();
		return lendings;
	}
